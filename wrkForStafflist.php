...
<?php include('./nav.php') ?>  
  ...
  <div class="btn_container d-flex justify-content-end">
    <a href="./export/wrk_staff_exp.php<?php echo $link ?>" class="btn btn-primary"><i class="fa fa-cloud-download" aria-hidden="true"></i> Export</a>
    </div>
      ...
      <tbody class="table-light">
        ...
        ?>
          <tr>
           ...
           <td><a <?php echo $row['wsorg_file']!=null?"href='".$row['wsorg_file']."'":'' ?> target="_blank"><?php echo $row['wsorg_file']!=null?'Go to file':'No file' ?></a></td>
           <td><a href="<?php echo "WorkshopForStaff.php?up_id=".$row['wsorg_id'] ?>">Edit</a></td>
           <td><a href="<?php echo "delete/wrkForstaff_del_.php?id=".$row['wsorg_id'] ?>">Delete</a></td>
