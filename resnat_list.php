...
<?php include('./nav.php') ?>  
  ...
  <div class="btn_container d-flex justify-content-end">
    <a href="./export/Res_nat_exp.php<?php echo $link ?>" class="btn btn-primary"><i class="fa fa-cloud-download" aria-hidden="true"></i> Export</a>
    </div>
      ...
      <tbody class="table-light">
        ...
        ?>
          <tr>
            ...
            <td><a href="<?php echo "delete/resnat_del_.php?id=".$row['npaperpublication_id'] ?>">Delete</a></td>
